...
class LoadHostData extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $host->setHostUID('1348232991-7e518eb46168a2f90e969304385e5d3c');
        ...
        $host->setHostUID('1348230493-3ea8bb35ed8d4a6d4932ccff62c4b994');
        $host->setStorage($storage);
        ...
        $host->setHostUID('1349274010-d6981936c54b627c562e477516ecd554');
        $host->setStorage($storage);
